                ...
                {asset.kind === "character" ? (
                  <div className="look-angles">
                    <figure>
                      ...
                      <figcaption>四分之三</figcaption>
                    </figure>
                    <figure>
                      <MediaPreview id={asset.viewImages?.front} files={files} />
                      <figcaption>正面</figcaption>
                    </figure>
                    <figure>
                      <MediaPreview id={asset.viewImages?.side} files={files} />
